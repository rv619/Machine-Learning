...
def train (train_data, hidden, h, d, c, class_mapping, bias, learning_rate = 0.1, eps = 0.001, epoch = 10000):
...
def test (test_data, w, h, d, c, class_mapping, bias):
...
def run (filename, hidden, h, d, c, classes, bias = 1.0):
    # Read the csv file
    ...
    # Train the data
    w = train (train_data, hidden, h, d, c, class_mapping, bias)
    # Display weights
    for i in range (h+1):
        print ("w [" + str(i) + "] = \n")
        print (w[i])
        print ()
    # Test the data
    test (test_data, w, h, d, c, class_mapping, bias)
...
def main ():
    ...
    print ("----------------------------------------------\n")
    classes = [1, 2]
    run (file1, hidden, h, d, c, classes)
    print ("\n----------------------------------------------")
    print ("Results (" + file2 + ")")
    print ("----------------------------------------------\n")
    classes = [-1, 1]
    run (file2, hidden, h, d, c, classes)
    print ("\n----------------------------------------------")
